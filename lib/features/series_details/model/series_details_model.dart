...
SeriesDetailsModel seriesDetailsModelFromJson(String str) =>
    SeriesDetailsModel.fromJson(json.decode(str));

String seriesDetailsModelToJson(SeriesDetailsModel data) =>
